...
(define-keyset "n_f9b22d2046c2a52575cc94f961c8b9a095e349e7.admin" (read-keyset "admin"))
(define-keyset "n_f9b22d2046c2a52575cc94f961c8b9a095e349e7.ops" (read-keyset "ops"))

(module kadenai-donate GOVERNANCE
  
    (defcap GOVERNANCE ()
    (enforce-guard (keyset-ref-guard "n_f9b22d2046c2a52575cc94f961c8b9a095e349e7.admin" ))
       )

    (defcap OPS()
    (enforce-guard (keyset-ref-guard "n_f9b22d2046c2a52575cc94f961c8b9a095e349e7.ops"))
       )
